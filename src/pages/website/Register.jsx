  ...
  return (
    <div className='max-w-6xl mx-auto py-10 px-10'>
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className='text-xl text-gray-500 my-2'>Register to your account!</p>
      </div>
      {/* form design */}
        ...
        <div className="shadow-2xl py-10 px-10">
          <form action="" method="post">
            ...
            <div className="mt-4">
              ...
              <input type="password" name="comfirmpassword" placeholder='Enter your comfirm password' className='w-full py-3 px-5 border border-gray-500 mt-2' />
            </div>
            <div className="mt-4">
              <button type="button" className='w-full bg-blue-400 text-white py-4'>Register</button>
            </div>
            <div className="mt-3">
              <h5 className='text-xl text-gray-500 text-center'>Do have an account <span className='text-blue-400 text-xl cursor-pointer' onClick={()=>navigate("/login")}>Login</span></h5>
            </div>
          </form>
        </div>
      </div>
